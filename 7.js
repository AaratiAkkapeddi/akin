...
let text = [
    "<h1>Crown Studio</h1><p>Coimbatore, Tamil Nadu.<br>This image looks like it maybe was created using a technique called vignetting where black or white paper is cut around a subject to isolate them and then a new print is made. It also appears to be painted over partially.</p>",
    "<h1>The City Photo Works Studio</h1><p>Coimbatore, Tamil Nadu.<br>This image looks like it maybe was created using a technique called vignetting where black or white paper is cut around a subject to isolate them and then a new print is made. It also appears to be painted over partially.</p>",
    ...
    "<h1>Unknown Studio</h1><p>Unknown location, Tamil Nadu<br><br>I believe this woman is christian and that she is holding The Bible.</p>",
    "<h1>Unknown Studio</h1><p>Unknown location, Tamil Nadu</p>",
    "<h1>Unknown Studio</h1><p>Unknown location, Tamil Nadu<br>I believe the sunglasses in this photo are cut from cardboard or some kind of paper.</p>",
